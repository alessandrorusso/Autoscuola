<?php die("Access Denied"); ?>#x#a:2:{s:6:"output";s:0:"";s:6:"result";s:21876:"/***************************************************************************************/
/*
...
.wrapper-inner
{
	background: url(/Autoscuola/templates/as002044free/images/styles/gray/bg.footer1.png) no-repeat scroll center bottom rgba(0, 0, 0, 0);
}

.body__home .wrapper-featured-top
{
	background-image: url(/Autoscuola/templates/as002044free/images/styles/gray/bg.wrapper.top.png);
}

.body__home .wrapper-featured-bottom
{
	background-image: url(/Autoscuola/templates/as002044free/images/styles/gray/bg.wrapper.bottom.png);
}

.wrapper-header
{
	background-image: url(/Autoscuola/templates/as002059/images/styles/black/bg.header.png);
}
...
#back-top span
{	
	background: url(/Autoscuola/templates/as002044free/images/styles/gray/up.arrow.png) no-repeat center center;
...
blockquote
{
	background-image: url(/Autoscuola/templates/as002044free/images/styles/black/blockquote.png);
}
...
#featured-row .container
{
	...
	//background-image: url(../images/styles/black/bg.featured.png);
}
...
{
	list-style-image: url(/Autoscuola/templates/as002044free/images/styles/black/liststyle.5.png);
}
...
{
	background-image:  url(/Autoscuola/templates/as002044free/images/styles/black/liststyle.4.png);	
}
