<?php die("Access Denied"); ?>#x#a:2:{s:6:"output";s:0:"";s:6:"result";s:53545:"/**************************************************************************************/
/*
...
body
{
	...
	font-size: 12px;
	color: #121212;
	background-image: url(/Autoscuola/templates/as002044free/images/bg.body.png);	
}
...
.wrapper-inner
{
	background: url(/Autoscuola/templates/as002044free/images/styles/default/bg.footer.png) no-repeat scroll center bottom rgba(0, 0, 0, 0);
}

.body__home .wrapper-featured-top
{
	background-image: url(/Autoscuola/templates/as002044free/images/styles/default/bg.wrapper.top.png);
...
{
	background-image: url(/Autoscuola/templates/as002044free/images/styles/default/bg.wrapper.bottom.png);
...
.wrapper-header
{
	background-image: url(/Autoscuola/templates/as002059/images/styles/default/bg.header.png);
	background-position: center top;
	background-repeat: no-repeat;
...
.moduletable ul.item-list li
{
	...
	background: url(/Autoscuola/templates/as002044free/images/liststyle.1.png) left 11px no-repeat;
	padding: 0 0 0 25px;
}
...
.toggle
{
	...
	font-size: 13px;
	font-weight: normal;
	background-image: url(/Autoscuola/templates/as002044free/images/bg.toggle.open.png);
	background-position: left top;
	background-repeat: no-repeat;
	cursor: pointer;
...
.toggle:hover
{
	background-image: url(/Autoscuola/templates/as002044free/images/bg.toggle.open.hover.png);
}

.toggle.opened
{
	background-image: url(/Autoscuola/templates/as002044free/images/bg.toggle.close.png);
	background-position: left top;
	background-repeat: no-repeat;
}
...
.toggle.opened:hover
{
	background-image: url(/Autoscuola/templates/as002044free/images/bg.toggle.close.hover.png);
}
...
#back-top span
{
	...
	display: block;
	margin-bottom: 7px;
	background: url(/Autoscuola/templates/as002044free/images/up.arrow.png) no-repeat center center;
	-webkit-transition: 1s;
	-moz-transition: 1s;
	transition: 1s;
	border-radius: 50%;
...
#galleryOverlay
{
	...
	background-image: url(/Autoscuola/templates/as002044free/images/bg.gallery.png);	
}
...
{
	background: url(/Autoscuola/templates/as002044free/images/system/preloader.gif) no-repeat center center;
	height: 100%;
	line-height: 1px;
	text-align: center;
	width:100%;
...
#nextArrow
{
	border:none;
	text-decoration:none;
	background:url(/Autoscuola/templates/as002044free/images/gallery/arrows.png) no-repeat;
	opacity:0.5;
	cursor:pointer;
	position:absolute;
	width:43px;
...
blockquote
{
	background-image: url(/Autoscuola/templates/as002044free/images/styles/default/blockquote.png);
	background-repeat: no-repeat;
	background-position:  left top;
	padding: 0 0 0 40px;
}
...
{
	background: url(/Autoscuola/templates/as002059/images/ico.search.png) 0px 0px no-repeat  !important;
...
#header-row .moduletable.search input
{
	...
	background-image: url(/Autoscuola/templates/as002044free/images/bg.menu.active.png) !important;
	border: none;
}
...
{
	line-height: 25px;
	list-style-image: url(/Autoscuola/templates/as002044free/images/liststyle.1.png);
...
{
	list-style-image: url(/Autoscuola/templates/as002044free/images/styles/default/liststyle.5.png);
}
...
{
	background: url(/Autoscuola/templates/as002044free/images/rewiew_bottom_line.png) no-repeat scroll 0 0 rgba(0, 0, 0, 0);
	float: left;
	padding: 30px 0 0;
	margin-top: 10px;
	width: 100%;
...
{
	background-image:  url(/Autoscuola/templates/as002044free/images/styles/default/liststyle.4.png);	
	background-position: left top;
	background-repeat: no-repeat;
	list-style-image: none;
	padding: 0 0 0 30px;
...
{
	background-image: url(/Autoscuola/templates/as002044free/images/ico.contactus.png);
    background-position: left top;
    background-repeat: no-repeat;
    min-height: 30px;
