...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" >
    ...
    <body class="<?php echo $option . " view-" . $view . " task-" . $task . " itemid-" . $itemid . " body__" . $pageClass; ?>">
        ...
        <?php if ($this->countModules('as-position-7') && $this->countModules('as-position-23')):
                            ?>
        ...
        <?php elseif($this->countModules('as-position-7')) : ?> 
        <div id="header-bottom-row" style="width: 91%;">
            <div class="container" >
                <div class="row" style="margin-top: 5%; margin-bottom: 5%">
        ...
        <?php elseif($this->countModules('as-position-23')) : ?>
        <div id="header-bottom-row" style="width: 91%;">
            <div class="container" >
                <div class="row" style="margin-top: 5%; margin-bottom: 5%">
                    <div class="col-xs-12 col-md-12 col-lg-12">
