...
$user_groups= implode(',',$user->groups);
 ...
 if (isset($_GET['filemanager_msg']) && htmlspecialchars($_GET['filemanager_msg']) != '') {
      ...
      <script>
        ...
        var dirUrl = "<?php echo $get_controller->get_uploads_url() . (isset($_REQUEST['dir']) ? $_REQUEST['dir'] . '/' : ''); ?>";
          ...
          <div id="uploader">
            ...
            <div class="ctrls_bar ctrls_bar_header">
              <div class="ctrls_left upload_thumb">
                ...
                <input type="text" class="ctrl_bar_btn upload_thumb_dim" name="upload_thumb_width" id="upload_thumb_width" value="<?php echo $get_controller->get_options_data()->upload_thumb_width; ?>" /> x 
                <input type="text" class="ctrl_bar_btn upload_thumb_dim" name="upload_thumb_height" id="upload_thumb_height" value="<?php echo $get_controller->get_options_data()->upload_thumb_height; ?>" /> px
              </div>
              <div class="ctrls_right">
