...
JHtml::_('behavior.tooltip');
 ...
 $rows_data = $this->get_rows_data;
    ...
    <div style="font-size: 14px; font-weight: bold;">
      ...
      <a style="color: blue; text-decoration: none;" target="_blank" href="http://web-dorado.com/joomla-gallery-guide-step-3.html">Read More in User Manual</a>
    </div>
              ...
              <tr id="tr_<?php echo $row_data->id; ?>" <?php echo $alternate; ?>>
                ...
                <td id="td_name_<?php echo $row_data->id; ?>" >
                  <a class="pointer" id="name<?php echo $row_data->id; ?>"
                     onclick="edit_tag(<?php echo $row_data->id; ?>)" 
                ...
                <td class="table_big_col" id="td_edit_<?php echo $row_data->id; ?>">
                  <a onclick="edit_tag(<?php echo $row_data->id; ?>)">Edit</a>
                </td>
