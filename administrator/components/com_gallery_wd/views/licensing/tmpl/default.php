     ...
     <div style="text-align:center; float: left;">
      <table class="data-bordered">
        ...
        <tbody>
          <tr class="alt">
            <td>Joomla! 2.5+ </td>
            <td class="bwg_icon-replace yes">yes</td>
            <td class="bwg_icon-replace yes">yes</td>
          </tr>
          <tr>
            <td>SEO-friendly</td>
          ...
          <tr class="alt">
            <td>Basic Tag Cloud module</td>
            <td class="bwg_icon-replace yes">yes</td>
            <td class="bwg_icon-replace yes">yes</td>
          </tr>
          <tr>
            <td>Photo Gallery Slideshow module</td>
            <td class="bwg_icon-replace yes">yes</td>
            <td class="bwg_icon-replace yes">yes</td>
          </tr>
          <tr class="alt">
            <td>Photo Gallery module</td>
            <td class="bwg_icon-replace yes">yes</td>
            <td class="bwg_icon-replace yes">yes</td>
          </tr>
          <tr>
          ...
          <tr class="alt">
            ...
            <td class="bwg_icon-replace no">no</td>
            <td class="bwg_icon-replace yes">yes</td>
          </tr>
          <tr>
          ...
          <tr class="alt">
            <td>Photo Gallery Tags Cloud module</td>
            <td class="bwg_icon-replace no">no</td>
            <td class="bwg_icon-replace yes">yes</td>
          </tr>
        </tbody>
