...
$gallery_rows = $this->get_gallery_rows_data;
    $album_rows = $this->get_album_rows_data;
    $option_row = $this->get_option_row_data;
    $theme_rows = $this->get_theme_rows_data;
    $effects = array(
      'none' => 'None',
          ...
          function bwg_update_shortcode() {
            ...
            if (!short_code) { // Insert.
              ...
              if (short_code['gallery_type'] != 'slideshow') {
                ...
                jQuery("select[id=popup_effect] option[value='" + short_code['popup_type'] + "']").attr('selected', 'selected');
          ...
          function bwg_insert_shortcode(content) {
            ...
            switch (gallery_type) {
              ...
              case 'slideshow': {
                ...
                tagtext += ' slideshow_enable_autoplay=' + jQuery("input[name=enable_slideshow_autoplay]:checked").val() + '';
                tagtext += ' slideshow_enable_shuffle=' + jQuery("input[name=enable_slideshow_shuffle]:checked").val() + '';
                tagtext += ' slideshow_enable_ctrl=' + jQuery("input[name=enable_slideshow_ctrl]:checked").val() + '';
                tagtext += ' slideshow_enable_filmstrip=' + jQuery("input[name=enable_slideshow_filmstrip]:checked").val() + '';
                ...
                tagtext += ' slideshow_enable_music=' + jQuery("input[name=enable_slideshow_music]:checked").val() + '';
                tagtext += ' slideshow_audio_url=' + str_replace(' ','%20',jQuery("#slideshow_music_url").val()) + '';             break;
              ...
              case 'album_compact_preview': {
                ...
                tagtext += ' show_search_box=' + jQuery("input[name=show_search_box]:checked").val() + '';
                tagtext += ' search_box_width=' + jQuery("#search_box_width").val() + '';
                tagtext += ' album_column_number=' + jQuery("#compuct_album_column_number").val() + '';
                tagtext += ' albums_per_page=' + jQuery("#compuct_albums_per_page").val() + '';
                tagtext += ' album_title_show_hover=' + jQuery("input[name=compuct_album_title]:checked").val() + '';
                tagtext += ' album_view_type=' + jQuery("input[name=compuct_album_view_type]:checked").val() + '';
                tagtext += ' album_thumb_width=' + jQuery("#compuct_album_thumb_width").val() + '';
                tagtext += ' album_thumb_height=' + jQuery("#compuct_album_thumb_height").val() + '';
                tagtext += ' image_column_number=' + jQuery("#compuct_album_image_column_number").val() + '';
                tagtext += ' images_per_page=' + jQuery("#compuct_album_images_per_page").val() + '';
                tagtext += ' image_title_show_hover=' + jQuery("input[name=compuct_album_image_title]:checked").val() + '';
                tagtext += ' thumb_width=' + jQuery("#compuct_album_image_thumb_width").val() + '';
                tagtext += ' thumb_height=' + jQuery("#compuct_album_image_thumb_height").val() + '';
                tagtext += ' album_enable_page=' + jQuery("input[name=compuct_album_enable_page]:checked").val() + '';
                break;
              ...
              case 'album_extended_preview': {
                ...
                tagtext += ' show_search_box=' + jQuery("input[name=show_search_box]:checked").val() + '';
                tagtext += ' search_box_width=' + jQuery("#search_box_width").val() + '';
                tagtext += ' albums_per_page=' + jQuery("#extended_albums_per_page").val() + '';
                ...
                tagtext += ' album_view_type=' + jQuery("input[name=extended_album_view_type]:checked").val() + '';
                tagtext += ' album_thumb_width=' + jQuery("#extended_album_thumb_width").val() + '';
                tagtext += ' album_thumb_height=' + jQuery("#extended_album_thumb_height").val() + '';
                tagtext += ' image_column_number=' + jQuery("#extended_album_image_column_number").val() + '';
                tagtext += ' images_per_page=' + jQuery("#extended_album_images_per_page").val() + '';
                tagtext += ' image_title_show_hover=' + jQuery("input[name=extended_album_image_title]:checked").val() + '';
                tagtext += ' thumb_width=' + jQuery("#extended_album_image_thumb_width").val() + '';
                tagtext += ' thumb_height=' + jQuery("#extended_album_image_thumb_height").val() + '';
                tagtext += ' album_enable_page=' + jQuery("input[name=extended_album_enable_page]:checked").val() + '';
                break;
            ...
            if (gallery_type != 'slideshow') {
              ...
              tagtext += ' popup_type=' + jQuery("#popup_effect").val() + '';
            ...
            if (jQuery("input[name=watermark_type]:checked").val() == 'text') {
			  ...
			  tagtext += ' watermark_url=' + str_replace(' ','%20',jQuery("#watermark_url").val()) + '';
            ...
            jQuery("#bwg_shortcode").val("{Loadgallery_wd" + tagtext + "}");
