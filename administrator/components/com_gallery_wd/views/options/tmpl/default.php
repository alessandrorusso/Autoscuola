...
$document->addScript(JURI::root() . 'components/com_gallery_wd/js/jscolor/jscolor.js');	
    ?>
    <div style="font-size: 14px; font-weight: bold;">
      This section allows you to change settings for different views and general options.
      <a style="color: blue; text-decoration: none;" target="_blank" href="http://web-dorado.com/joomla-gallery-guide-step-5/5-1.html">Read More in User Manual</a>
    </div>
    ...
    <script>
      ...
      function bwg_add_built_in_watermark_image(files) {
        document.getElementById("built_in_watermark_url").value = '<?php echo JURI::root()  . WD_BWG_UPLOAD_DIR.'/'; ?>' + files[0]['url'];
      }
      function bwg_add_watermark_image(files) {
        document.getElementById("watermark_url").value = '<?php echo JURI::root()  . WD_BWG_UPLOAD_DIR.'/'; ?>' + files[0]['url'];
      }
    </script>
	<style>
    ...
    foreach (scandir(WD_BWG_DIR .'/fonts') as $filename) {
    ...
    ?>
    <form method="post" class="wrap" id="adminForm" name="arminForm" action="index.php?option=com_gallery_wd&view=options" style="width:95%;">      
      ...
      <div style="display: none; width: 100%;" id="display_panel">
        <div style="float:left;">
          ...
          <input type="hidden" id="type" name="type" value="<?php echo (isset($_POST["type"]) ? htmlspecialchars(stripslashes($_POST["type"])) : "1"); ?>"/>
        </div>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  <div class="spider_description">Input an existing directory inside the Joomla! directory to store uploaded images.<br />Old directory content will be moved to the new one.</div>
                </td>
              </tr>
			   <tr>
                <td class="spider_label_options">
                  ...
                  <tbody>
                    ...
                    <tr id="tr_built_in_watermark_url">
                      ...
                      <td>
                        ...
                        <a class="modal" rel="{handler: 'iframe', size: {x: 700, y: 600}}" href="index.php?option=com_gallery_wd&view=filemanager&extensions=png&callback=bwg_add_built_in_watermark_image&tmpl=component" id="button_add_built_in_watermark_image" class="button-primary thickbox thickbox-preview"
                           title="Add image" 
                    ...
                    <tr id="tr_built_in_watermark_text">
                      ...
                      <td>
                        <input type="text" name="built_in_watermark_text" id="built_in_watermark_text" style="width: 90%;" value="<?php echo $row->built_in_watermark_text; ?>" onchange="preview_built_in_watermark()" onkeypress="preview_built_in_watermark()" />
                        <div class="spider_description"></div>
                      </td>
                    </tr>
                    ...
                    <tr id="tr_built_in_watermark_font_size">
                      ...
                      <td>
                        <input type="text" name="built_in_watermark_font_size" id="built_in_watermark_font_size" value="<?php echo $row->built_in_watermark_font_size; ?>" class="spider_int_input" onchange="preview_built_in_watermark()" /> px
                        <div class="spider_description"></div>
                      </td>
                    </tr>
                  ...
                  <tbody>
                    ...
                    <tr id="tr_watermark_url">
                      ...
                      <td>
                        ...
                        <a  class="modal" rel="{handler: 'iframe', size: {x: 700, y: 550}}"  href="index.php?option=com_gallery_wd&view=filemanager&extensions=jpg,jpeg,png,gif&callback=bwg_add_watermark_image&tmpl=component" id="button_add_watermark_image" class="button-primary thickbox thickbox-preview"
                           title="Add image" 
                           onclick="return false;"
                           style="margin-bottom:5px;">
                          Add Image
                    ...
                    <tr id="tr_watermark_text">
                      ...
                      <td>
                        <input type="text" name="watermark_text" id="watermark_text" style="width: 90%;" value="<?php echo $row->watermark_text; ?>" onchange="preview_watermark()" onkeypress="preview_watermark()" />
                        <div class="spider_description"></div>
                      </td>
                    </tr>
                    <tr id="tr_watermark_link">
                      ...
                      <td>
                        <input type="text" name="watermark_link" id="watermark_link" style="width: 90%;" value="<?php echo $row->watermark_link; ?>" onchange="preview_watermark()" onkeypress="preview_watermark()" />
            ...
            <tbody>
			 <tr id="tr_popup_full_width">
              ...
              <tr>
                ...
                <td>
                  <input type="radio" disabled="disabled" name="popup_enable_filmstrip" id="popup_enable_filmstrip_1" value="1" <?php if ($row->popup_enable_filmstrip ) echo 'checked="checked"'; ?> onClick="bwg_enable_disable('', 'tr_popup_filmstrip_height', 'popup_enable_filmstrip_1')" /><label for="popup_enable_filmstrip_1">Yes</label>
                  <input type="radio" disabled="disabled" name="popup_enable_filmstrip" id="popup_enable_filmstrip_0" value="0" <?php if (!$row->popup_enable_filmstrip ) echo 'checked="checked"'; ?> onClick="bwg_enable_disable('none', 'tr_popup_filmstrip_height', 'popup_enable_filmstrip_0')" /><label for="popup_enable_filmstrip_0">No</label>
<div class="spider_description spider_free_version">This option is disabled in free version.</div>                </td>
              </tr>
              ...
              <tr id="tr_popup_filmstrip_height">
                ...
                <td>
                  <input disabled="disabled" type="text" name="popup_filmstrip_height" id="popup_filmstrip_height" value="<?php echo $row->popup_filmstrip_height; ?>" class="spider_int_input" /> px
<div class="spider_description spider_free_version">This option is disabled in free version.</div>                </td>
              </tr>
...
<div class="spider_description spider_free_version">This option is disabled in free version.</div>                </td>
              ...
              <tr id="tr_popup_rate">
                ...
                <td>
                  <input type="radio" disabled="disabled" name="popup_enable_rate" id="popup_enable_rate_1" value="1" <?php if ($row->popup_enable_rate) echo 'checked="checked"'; ?> /><label for="popup_enable_rate_1">Yes</label>
                  <input type="radio" disabled="disabled" name="popup_enable_rate" id="popup_enable_rate_0" value="0" <?php if (!$row->popup_enable_rate) echo 'checked="checked"'; ?> /><label for="popup_enable_rate_0">No</label>
<div class="spider_description spider_free_version">This option is disabled in free version.</div>
              ...
              <tr id="tr_popup_comment">
                ...
                <td>
                  <input type="radio" disabled="disabled" name="popup_enable_comment" id="popup_enable_comment_1" value="1" <?php if ($row->popup_enable_comment) echo 'checked="checked"'; ?> onClick="bwg_enable_disable('', 'tr_popup_email', 'popup_enable_comment_1');
                                                                                                                                                                                     bwg_enable_disable('', 'tr_popup_captcha', 'popup_enable_comment_1');" /><label for="popup_enable_comment_1">Yes</label>
                  <input type="radio" disabled="disabled" name="popup_enable_comment" id="popup_enable_comment_0" value="0" <?php if (!$row->popup_enable_comment) echo 'checked="checked"'; ?> onClick="bwg_enable_disable('none', 'tr_popup_email', 'popup_enable_comment_0');
...
<div class="spider_description spider_free_version">This option is disabled in free version.</div>
			   ...
			   <tr id="tr_comment_moderation">
                ...
                <td>
                  <input type="radio" disabled="disabled" name="comment_moderation" id="comment_moderation_1" value="1" <?php if ($row->comment_moderation) echo 'checked="checked"'; ?> /><label for="comment_moderation_1">Yes</label>
                  <input type="radio" disabled="disabled" name="comment_moderation" id="comment_moderation_0" value="0" <?php if (!$row->comment_moderation) echo 'checked="checked"'; ?> /><label for="comment_moderation_0">No</label>
<div class="spider_description spider_free_version">This option is disabled in free version.</div>
                </td>
              </tr>
              ...
              <tr id="tr_popup_email">
                ...
                <td>
                  <input type="radio" disabled="disabled" name="popup_enable_email" id="popup_enable_email_1" value="1" <?php if ($row->popup_enable_email) echo 'checked="checked"'; ?> /><label for="popup_enable_email_1">Yes</label>
                  <input type="radio" disabled="disabled" name="popup_enable_email" id="popup_enable_email_0" value="0" <?php if (!$row->popup_enable_email) echo 'checked="checked"'; ?> /><label for="popup_enable_email_0">No</label>
<div class="spider_description spider_free_version">This option is disabled in free version.</div>
                </td>
              </tr>
              <tr id="tr_popup_captcha">
                ...
                <td>
                  <input type="radio" disabled="disabled" name="popup_enable_captcha" id="popup_enable_captcha_1" value="1" <?php if ($row->popup_enable_captcha) echo 'checked="checked"'; ?> /><label for="popup_enable_captcha_1">Yes</label>
                  <input type="radio" disabled="disabled" name="popup_enable_captcha" id="popup_enable_captcha_0" value="0" <?php if (!$row->popup_enable_captcha) echo 'checked="checked"'; ?> /><label for="popup_enable_captcha_0">No</label>
<div class="spider_description spider_free_version">This option is disabled in free version.</div>
                </td>
              </tr>
              ...
              <tr id="tr_popup_facebook">
                ...
                <td>
                  <input type="radio" disabled="disabled" name="popup_enable_facebook" id="popup_enable_facebook_1" value="1" <?php if ($row->popup_enable_facebook) echo 'checked="checked"'; ?> /><label for="popup_enable_facebook_1">Yes</label>
                  <input type="radio" disabled="disabled" name="popup_enable_facebook" id="popup_enable_facebook_0" value="0" <?php if (!$row->popup_enable_facebook) echo 'checked="checked"'; ?> /><label for="popup_enable_facebook_0">No</label>
<div class="spider_description spider_free_version">This option is disabled in free version.</div>
                </td>
              </tr>
          ...
          <table>
            <tbody>
			  ...
			  <tr>
                ...
                <td>
                  <input type="radio" disabled="disabled" name="album_view_type" id="album_view_type_1" value="thumbnail" <?php if ($row->album_view_type == "thumbnail") echo 'checked="checked"'; ?> /><label for="album_view_type_1">Thumbnail</label>
                  <input type="radio" disabled="disabled" name="album_view_type" id="album_view_type_0" value="masonry" <?php if ($row->album_view_type == "masonry") echo 'checked="checked"'; ?> /><label for="album_view_type_0">Masonry</label>
<div class="spider_description spider_free_version">This option is disabled in free version.</div>
                </td>
              </tr>
...
<div class="spider_description spider_free_version">This option is disabled in free version.</div>
                    ...
                    <tr id="tr_slideshow_filmstrip_height">
                      ...
                      <td>
                        <input disabled="disabled" type="text" name="slideshow_filmstrip_height" id="slideshow_filmstrip_height" value="<?php echo $row->slideshow_filmstrip_height; ?>" class="spider_int_input" /> px
<div class="spider_description spider_free_version">This option is disabled in free version.</div>
                      </td>
                    </tr>
                  </tbody>
                  ...
                  <tbody>
                    ...
                    <tr id="tr_slideshow_music_url">
                      ...
                      <td>
                        ...
                        <a class="modal" rel="{handler: 'iframe', size: {x: 700, y: 600}}" href="index.php?option=com_gallery_wd&view=filemanager&extensions=aac,m4a,f4a,mp3,ogg,oga&callback=bwg_add_music&tmpl=component" id="button_add_music" class="button-primary thickbox thickbox-preview"
                           title="Add music"
                           onclick="return false;"
                           style="margin-bottom:5px;">
                          Add Music
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <input type="radio" disabled="disabled" name="blog_style_title_enable" id="blog_style_title_enable_1" value="1" <?php if ($row->blog_style_title_enable) echo 'checked="checked"'; ?> /><label for="blog_style_title_enable_1">Yes</label>
                  <input type="radio" disabled="disabled" name="blog_style_title_enable" id="blog_style_title_enable_0" value="0" <?php if (!$row->blog_style_title_enable) echo 'checked="checked"'; ?> /><label for="blog_style_title_enable_0">No</label>
<div class="spider_description spider_free_version">This option is disabled in free version.</div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input disabled="disabled" type="text" name="blog_style_width" id="blog_style_width" value="<?php echo $row->blog_style_width; ?>" class="spider_int_input" /> px
<div class="spider_description spider_free_version">This option is disabled in free version.</div>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input disabled="disabled" type="text" name="blog_style_images_per_page" id="blog_style_images_per_page" value="<?php echo $row->blog_style_images_per_page; ?>" class="spider_int_input" />
<div class="spider_description spider_free_version">This option is disabled in free version.</div>
                </td>
              </tr>
              <tr>
...
<div class="spider_description spider_free_version">This option is disabled in free version.</div>
      ...
      <script>
        window.onload = bwg_change_option_type('<?php echo JRequest::getVar('type')!='' ? JRequest::getVar('type') : '1'; ?>');
