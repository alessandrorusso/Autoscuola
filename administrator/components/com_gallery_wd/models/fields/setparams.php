...
?>
        ...
        <script language="javascript" type="text/javascript" src="<?php echo WD_BWG_URL . '/js/jscolor/jscolor.js'; ?>"></script>
         <script language="javascript" type="text/javascript" src="<?php echo WD_BWG_URL . '/js/jquery.ui.js'; ?>"></script>  
...
margin-left: 0px !important;
              ...
              <div style="text-align:center; height:100px;">
                ...
                <span title="This view is disabled in free version."  class="gallery_type">
                  <div style="text-align: center;"><input disabled="disabled" type="radio" id="thumbnails_masonry" name="gallery_type" value="thumbnails_masonry" /><label for="thumbnails_masonry">Masonry</label></div>
                  <label for="thumbnails_masonry"><img style="opacity:0.5; filter: Alpha(opacity=50);" disabled="disabled" src="<?php echo WD_BWG_URL . '/images/thumbnails_masonry.jpg'; ?>" /></label>
                </span>
                ...
                <span title="This view is disabled in free version." class="gallery_type" >
                  <div style="text-align: center;"><input  disabled="disabled" type="radio" id="blog_style" name="gallery_type" value="blog_style" /><label for="blog_style">Blog Style</label></div>
                  <label for="blog_style"><img style="opacity:0.5; filter: Alpha(opacity=50);" disabled="disabled" src="<?php echo WD_BWG_URL . '/images/blog_style.jpg'; ?>" /></label>
                </span>
              </div>
              <hr />
              ...
              <table>
                <tbody>
                  <tr id="tr_theme">
                    <td title="This option is disabled in free version." class="spider_label spider_free_version_label"><label for="theme">Theme: </label></td>
                    <td>
                      <select name="theme" disabled="disabled" id="theme" style="width:150px;">
                    ...
                    <td>
                      <select name="album" id="album" style="width:150px;">
                        ...
                        foreach ($album_rows as $album_row) {
                          ?>
                          <option <?php if(isset($params['album_id']) AND $album_row->id==$params['album_id']) echo 'selected="selected"' ?> value="<?php echo $gallery_row->id; ?>"><?php echo $gallery_row->name; ?></option>
                          <?php
                        }
                        ?>
                      </select>
                  ...
                  <tr id="tr_compuct_album_view_type">
                    ...
                    <td>
                      <input type="radio" disabled="disabled" name="compuct_album_view_type" id="compuct_album_view_type_1" value="thumbnail" <?php if ($option_row->album_view_type == "thumbnail") echo 'checked="checked"'; ?> onchange="bwg_change_compuct_album_view_type()" /><label for="compuct_album_view_type_1">Thumbnail</label>
                      <input type="radio" disabled="disabled" name="compuct_album_view_type" id="compuct_album_view_type_0" value="masonry" <?php if ($option_row->album_view_type == "masonry") echo 'checked="checked"'; ?> onchange="bwg_change_compuct_album_view_type()" /><label for="compuct_album_view_type_0">Masonry</label>
                    </td>
                  </tr>
                  ...
                  <tr id="tr_extended_album_view_type">
                    <td title="The gallery images view type in the album.<br><br>This option is disabled in free version." class="spider_label spider_free_version_label"><label>Album view type: </label></td>
                    <td>
                      <input type="radio" disabled="disabled" name="extended_album_view_type" id="extended_album_view_type_1" value="thumbnail" <?php if ($option_row->album_view_type == "thumbnail") echo 'checked="checked"'; ?> onchange="bwg_change_extended_album_view_type()" /><label for="extended_album_view_type_1">Thumbnail</label>
                      <input type="radio" disabled="disabled" name="extended_album_view_type" id="extended_album_view_type_0" value="masonry" <?php if ($option_row->album_view_type == "masonry") echo 'checked="checked"'; ?> onchange="bwg_change_extended_album_view_type()" /><label for="extended_album_view_type_0">Masonry</label>
                    </td>
                  </tr>				  
                  ...
                  <tr id="tr_slideshow_effect">
                    <td title="This option is disabled in free version." class="spider_label spider_free_version_label"><label for="slideshow_effect">Slideshow Effect: </label></td>
                    <td>
                      <select name="slideshow_effect" id="slideshow_effect" style="width:150px;">
                        <?php
                        foreach ($effects as $key => $effect) {
                          ?>
 <option value="<?php echo $key; ?>" <?php echo ($key != 'none' && $key != 'fade') ? 'disabled="disabled" title="This effect is disabled in free version."' : ''; ?> <?php echo ($option_row->slideshow_type == $key) ? 'selected' : ''; ?>><?php echo $effect; ?></option>                          <?php
                        }
                        ?>
                      </select>
                    </td>
                  ...
                  <tr id="tr_enable_slideshow_filmstrip">
                    ...
                    <td>
                      <input type="radio" disabled="disabled" name="enable_slideshow_filmstrip" id="slideshow_filmstrip_yes" value="1" onClick="bwg_enable_disable('', 'tr_slideshow_filmstrip_height', 'slideshow_filmstrip_yes')" <?php echo ($option_row->slideshow_enable_filmstrip) ? 'checked' : ''; ?> /><label for="slideshow_filmstrip_yes">Yes</label>
                      <input type="radio" disabled="disabled" name="enable_slideshow_filmstrip" id="slideshow_filmstrip_no" value="0" onClick="bwg_enable_disable('none', 'tr_slideshow_filmstrip_height', 'slideshow_filmstrip_no')" <?php echo ($option_row->slideshow_enable_filmstrip) ? '' : 'checked'; ?> /><label for="slideshow_filmstrip_no">No</label>
                    </td>
                  </tr>
                  <tr id="tr_slideshow_filmstrip_height">
                    <td  title="This option is disabled in free version." class="spider_label spider_free_version_label"><label for="slideshow_filmstrip_height">Slideshow Filmstrip size: </label></td>
                    <td><input type="text" disabled="disabled" name="slideshow_filmstrip_height" id="slideshow_filmstrip_height" value="<?php echo $option_row->slideshow_filmstrip_height; ?>" class="spider_int_input" /> px</td>
                  </tr>
                </tbody>
              </table>
              </div>
              ...
              <table>
                ...
                <tbody id="tbody_popup">
                  ...
                  <tr id="tr_popup_effect">
                    <td title="Lightbox slideshow effect. <br><br>This option is disabled in free version." class="spider_label spider_free_version_label"><label for="popup_effect">Lightbox effect: </label></td>
                    <td>
                  ...
                  <tr id="tr_popup_enable_filmstrip">
                    <td title="Enable filmstrip view for images <br><br>This option is disabled in free version." class="spider_label spider_free_version_label"  class="spider_label"><label>Enable filmstrip in lightbox: </label></td>
                    <td>
                  ...
                  <tr id="tr_popup_filmstrip_height">
                    ...
                    <td><input type="text" disabled="disabled" name="popup_filmstrip_height" id="popup_filmstrip_height" value="<?php echo $option_row->popup_filmstrip_height; ?>" class="spider_int_input" /> px</td>
                  </tr>
                  <tr id="tr_popup_hit_counter">
                    ...
                    <td>
                      <input type="radio" disabled="disabled" name="popup_hit_counter" id="popup_hit_counter_yes" value="1" <?php echo ($option_row->popup_hit_counter) ? 'checked' : ''; ?> /><label for="popup_hit_counter_yes">Yes</label>
                      <input type="radio" disabled="disabled" name="popup_hit_counter" id="popup_hit_counter_no" value="0" <?php echo ($option_row->popup_hit_counter) ? '' : 'checked'; ?> /><label for="popup_hit_counter_no">No</label>
                    </td>
                  </tr>
                ...
                <tbody id="tbody_popup_ctrl_btn">
                  ...
                  <tr id="tr_popup_enable_google">
                    ...
                    <td>
                      <input type="radio" disabled="disabled" name="popup_enable_google" id="popup_google_yes" value="1" <?php echo ($option_row->popup_enable_google) ? 'checked' : ''; ?> /><label for="popup_google_yes">Yes</label>
                      <input type="radio" disabled="disabled" name="popup_enable_google" id="popup_google_no" value="0" <?php echo ($option_row->popup_enable_google) ? '' : 'checked'; ?> /><label for="popup_google_no">No</label>
                    </td>
                  </tr>
          ...
          function bwg_insert_shortcode(content) {
            ...
            switch (gallery_type) {
              ...
              case 'slideshow': {
                ...
                tagtext += '**PARAM**sort_by=' + jQuery("#sort_by").val() + '';
                tagtext += '**PARAM**order_by=' + jQuery("input[name=order_by]:checked").val() + '';
                tagtext += '**PARAM**slideshow_type=' + jQuery("#slideshow_effect").val() + '';
                ...
                tagtext += '**PARAM**slideshow_enable_autoplay=' + jQuery("input[name=enable_slideshow_autoplay]:checked").val() + '';
              tagtext += '**PARAM**slideshow_enable_shuffle=' + jQuery("input[name=enable_slideshow_shuffle]:checked").val() + '';
                tagtext += '**PARAM**slideshow_enable_ctrl=' + jQuery("input[name=enable_slideshow_ctrl]:checked").val() + '';
                tagtext += '**PARAM**slideshow_enable_filmstrip=' + jQuery("input[name=enable_slideshow_filmstrip]:checked").val() + '';
                ...
                tagtext += '**PARAM**slideshow_enable_music=' + jQuery("input[name=enable_slideshow_music]:checked").val() + '';
              ...
              case 'album_compact_preview': {
                ...
                tagtext += '**PARAM**show_search_box=' + jQuery("input[name=show_search_box]:checked").val() + '';
                tagtext += '**PARAM**search_box_width=' + jQuery("#search_box_width").val() + '';
                tagtext += '**PARAM**album_column_number=' + jQuery("#compuct_album_column_number").val() + '';
                tagtext += '**PARAM**albums_per_page=' + jQuery("#compuct_albums_per_page").val() + '';
                tagtext += '**PARAM**album_title_show_hover=' + jQuery("input[name=compuct_album_title]:checked").val() + '';
                tagtext += '**PARAM**album_view_type=' + jQuery("input[name=compuct_album_view_type]:checked").val() + '';
				
				
                tagtext += '**PARAM**album_thumb_width=' + jQuery("#compuct_album_thumb_width").val() + '';
                tagtext += '**PARAM**album_thumb_height=' + jQuery("#compuct_album_thumb_height").val() + '';
                tagtext += '**PARAM**image_column_number=' + jQuery("#compuct_album_image_column_number").val() + '';
                tagtext += '**PARAM**images_per_page=' + jQuery("#compuct_album_images_per_page").val() + '';
                tagtext += '**PARAM**image_title_show_hover=' + jQuery("input[name=compuct_album_image_title]:checked").val() + '';
                tagtext += '**PARAM**thumb_width=' + jQuery("#compuct_album_image_thumb_width").val() + '';
                tagtext += '**PARAM**thumb_height=' + jQuery("#compuct_album_image_thumb_height").val() + '';
                tagtext += '**PARAM**album_enable_page=' + jQuery("input[name=compuct_album_enable_page]:checked").val() + '';
                break;
              ...
              case 'album_extended_preview': {
                ...
                tagtext += '**PARAM**show_search_box=' + jQuery("input[name=show_search_box]:checked").val() + '';
                tagtext += '**PARAM**search_box_width=' + jQuery("#search_box_width").val() + '';
                tagtext += '**PARAM**albums_per_page=' + jQuery("#extended_albums_per_page").val() + '';
                ...
                tagtext += '**PARAM**album_view_type=' + jQuery("input[name=extended_album_view_type]:checked").val() + '';
                tagtext += '**PARAM**album_thumb_width=' + jQuery("#extended_album_thumb_width").val() + '';
                tagtext += '**PARAM**album_thumb_height=' + jQuery("#extended_album_thumb_height").val() + '';
                tagtext += '**PARAM**image_column_number=' + jQuery("#extended_album_image_column_number").val() + '';
                tagtext += '**PARAM**images_per_page=' + jQuery("#extended_album_images_per_page").val() + '';
                tagtext += '**PARAM**image_title_show_hover=' + jQuery("input[name=extended_album_image_title]:checked").val() + '';
                tagtext += '**PARAM**thumb_width=' + jQuery("#extended_album_image_thumb_width").val() + '';
                tagtext += '**PARAM**thumb_height=' + jQuery("#extended_album_image_thumb_height").val() + '';
                tagtext += '**PARAM**album_enable_page=' + jQuery("input[name=extended_album_enable_page]:checked").val() + '';
                break;
            ...
            if (gallery_type != 'slideshow') {
              ...
              tagtext += '**PARAM**popup_type=' + jQuery("#popup_effect").val() + '';
            ...
            tagtext += '**PARAM**watermark_link=' + jQuery("#watermark_link").val() + '';
