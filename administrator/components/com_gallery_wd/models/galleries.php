...
class gallery_wdModelGalleries extends JModelLegacy
{
 ...
 $author=$db->loadResult();
   ...
   //!current_user_can('manage_options') &&
    ...
    $image_order_by = ' ORDER BY `' .JRequest::getVar('image_order_by','order') . '` ' . $asc_or_desc;
    if (JRequest::getVar('page_number')!='') {
     ...
     $query="SELECT * FROM #__bwg_image " . $where . " AND gallery_id='" . $db->escape($gallery_id) . "' " . $image_order_by . " LIMIT " . $limit . ",20";
