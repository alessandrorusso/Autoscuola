...
for ($i = 0, $n = count($this->calendars); $i < $n; $i++) {
    ...
    ?>
                            ...
                            <?php foreach ($this->office as $currentOffice): ?>
                                <?php if ($row['office'] == $currentOffice['id']) { ?>
                                    <td><?php echo $currentOffice['desc']; ?></td>
                                <?php } ?>
                            <?php endforeach; ?>      
                            <?php foreach ($this->license as $currentLicense): ?>
                                <?php if ($row['license'] == $currentLicense['id']) { ?>
                                    <td><?php echo $currentLicense['desc']; ?></td>
                                <?php } ?>
                            <?php endforeach; ?>      
                            <?php foreach ($this->transport as $currentTransport): ?>
                                <?php if ($row['transport'] == $currentTransport['id']) { ?>
                                    <td><?php echo $currentTransport['desc']; ?></td>
                                <?php } ?>
                            <?php endforeach; ?>      
