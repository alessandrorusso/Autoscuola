...
function save_tag(tag_id) { 
  ...
  var datas = "&task=tags.edit_tag&name="+tagname+"&"+"slug="+slug+"&"+"id="+tag_id;
 ...
 jQuery.ajax({ 
  ...
  else { massege="Item Successfully Saved.";
  ...
  var func1="spider_set_input_value('task', 'tags.delete');";
  var func2="spider_set_input_value('current_id', "+tag_id+");";
  var func3="spider_form_submit('event', 'adminForm')";
...
function spider_ajax_save(form_id, tr_group) {
  ...
  post_data["task"] = "galleries.ajax_search";
  ...
  jQuery.post(
    ...
    if (tr_count > bwg_save_count * tr_group) {
      ...
      if (ajax_task == 'ajax_apply') {
        jQuery('#message_div').html("<strong><p>Items Successfully Saved.</p></strong>");
        jQuery('#message_div').show();
      }
      else if (ajax_task == 'recover') {
        jQuery('#draganddrop').html("<strong><p>Item Successfully Recovered.</p></strong>");
        jQuery('#draganddrop').show();
      }
      else if (ajax_task == 'image_publish') {
        jQuery('#draganddrop').html("<strong><p>Item Successfully Published.</p></strong>");
        jQuery('#draganddrop').show();
      }
      else if (ajax_task == 'image_unpublish') {
        jQuery('#draganddrop').html("<strong><p>Item Successfully Unpublished.</p></strong>");
        jQuery('#draganddrop').show();
      }
      else if (ajax_task == 'image_delete') {
        jQuery('#draganddrop').html("<strong><p>Item Successfully Deleted.</p></strong>");
        jQuery('#draganddrop').show();
      }
        ...
        jQuery('#draganddrop').html("<strong><p>Items Successfully Published.</p></strong>");
        jQuery('#draganddrop').show();
      }
      else if (ajax_task == 'image_unpublish_all') {
        jQuery('#draganddrop').html("<strong><p>Items Successfully Unpublished.</p></strong>");
        jQuery('#draganddrop').show();
      }
      else if (ajax_task == 'image_delete_all') {
        jQuery('#draganddrop').html("<strong><p>Items Successfully Deleted.</p></strong>");
        jQuery('#draganddrop').show();
      }
      else if (ajax_task == 'image_set_watermark') {
        jQuery('#draganddrop').html("<strong><p>Watermarks Successfully Set.</p></strong>");
        jQuery('#draganddrop').show();
      }
      else if (ajax_task == 'image_recover_all') {
        jQuery('#draganddrop').html("<strong><p>Items Successfully Reset.</p></strong>");
        jQuery('#draganddrop').show();
      }
      else {
        jQuery('#draganddrop').html("<strong><p>Items Successfully Saved.</p></strong>");
        jQuery('#draganddrop').show();
      }
      if (ajax_task == "ajax_save") {
...
function spider_show_hide_weights() {
  ...
  if (jQuery("#show_hide_weights").val() == 'Show order column') {
    ...
    var page_number;
	page_num=parseInt(jQuery('.pagination-toolbar').find('ul').find('.active').children().html());
    if (page_num && page_num != '' && page_num != 1) {
      page_number = (page_num - 1) * jQuery('#limit').val() + 1;
    }
    else {
      page_number = 1;
    }
