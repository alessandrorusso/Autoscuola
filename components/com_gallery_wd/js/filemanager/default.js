...
function submit(task, sortBy, sortOrder, itemsView, destDir, fileNewName, newDirName, clipboardTask, clipboardFiles, clipboardSrc, clipboardDest) {
  ...
  switch (task) {
    case "filemanager.rename_item":
      destDir = dir;
      newDirName = "";
      clipboardTask = ""
      clipboardDest = "";
      break;
    case "filemanager.remove_items":
      destDir = dir;
      fileNewName = "";
      newDirName = "";
      clipboardTask = ""
      clipboardDest = "";
      break;
    case "filemanager.make_dir":
      destDir = dir;
      fileNewName = "";
      clipboardTask = ""
      clipboardDest = "";
      break;
    case "filemanager.paste_items":
      destDir = dir;
      fileNewName = "";
      newDirName = "";
      break;
...
function submitFiles() {
  jQuery('#opacity_div').css('display','');
  jQuery('#loading_div').css('display','');
  if (filesSelected.length == 0) {
    return;
  }
  var filesValid = [];
...
function onBtnMakeDirClick(event, obj) {
  ...
  if ((newDirName) && (newDirName != "")) {
    submit("filemanager.make_dir", null, null, null, null, null, newDirName, null, null, null, null);
  }
}
...
function onBtnRenameItemClick(event, obj) {
  if (filesSelected.length != 0) {
    ...
    if ((newName != null) && (newName != "")) {
      submit("filemanager.rename_item", null, null, null, null, newName, null, null, null, null, null);
    }
  }
}
...
function onBtnPasteClick(event, obj) {
  if (getClipboardFiles() != "") {
    submit("filemanager.paste_items", null, null, null, null, null, null, null, null, null, dir);
  }
}

function onBtnRemoveItemsClick(event, obj) {
  if ((filesSelected.length != 0) && (confirm(warningRemoveItems) == true)) {
    submit("filemanager.remove_items", null, null, null, null, null, null, null, null, null, null);
  }
}
...
function onFileDrop(event, obj) {
  ...
  submit("filemanager.paste_items", null, null, null, null, null, null, clipboardTask, dragFiles.join(","), dir, clipboardDest);
  event.preventDefault();
}
