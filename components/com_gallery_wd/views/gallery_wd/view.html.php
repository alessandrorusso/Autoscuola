	...
	function display($tpl = null) 
	{
	 ...
	 $bwg=0;
		...
		if($params['gallery_type']=='slideshow' OR $params['gallery_type']=='image_browser' OR $params['gallery_type']=='blog_style')
			...
			$this->get_image_rows_data=$model->get_image_rows_data($params['gallery_id'],  $images_per_page, $params['sort_by'], 0,$type);
			...
			$this->get_alb_gals_row=$model->get_alb_gals_row($album_gallery_id, $items_per_page, $params['sort_by'], 0);
			...
			$this->get_image_rows_data=$model->get_image_rows_data($gal_id,  '', 'order', 0,'');
